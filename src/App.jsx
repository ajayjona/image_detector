      ...
      <main className="flex-1 overflow-y-auto scroll-smooth bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-50/50 via-slate-50 to-slate-50">
        <div className="max-w-7xl mx-auto p-8 space-y-12">
          ...
          <div className="space-y-4 relative">
            ...
            <h2 className="text-5xl font-black tracking-tighter text-slate-900 bg-clip-text text-transparent bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900">
              Your Local Photo Library
            </h2>
            <p className="text-xl text-slate-500 max-w-2xl leading-relaxed">
              Process your photos locally for <span className="text-blue-600 font-semibold underline decoration-2 decoration-blue-200 underline-offset-4">total privacy</span>. We use browser AI to curate your best moments.
            </p>
          </div>
